...
public class ViewTransitionContext<RouteType: Route, CoordinatorType: ViewCoordinator>: TransitionContext where RouteType == CoordinatorType.RouteType {
    ...
    weak public var prevTransitionContext: ViewTransitionContext<RouteType, CoordinatorType>?
    weak public var prevRouter: (any Router<RouteType>)? {
        prevTransitionContext
    }
    weak public var nextTransitionContext: ViewTransitionContext<RouteType, CoordinatorType>?
    ...
    required public init(rootRoute: RouteType, delegate: CoordinatorType?, isRoot: Bool = false, prevTransitionContext: ViewTransitionContext<RouteType, CoordinatorType>? = nil) {
