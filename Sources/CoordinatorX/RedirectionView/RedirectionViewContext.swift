...
public struct RedirectionViewContext<RouteType: Route,
    ...
    @StateObject
    public var tranisitionContext: RedirectionViewTransitionContext<RouteType, CoordinatorType>
    ...
    public init(rootRoute: RouteType, coordinator: CoordinatorType, isRoot: Bool = false, prevTransitionContext: RedirectionViewTransitionContext<RouteType, CoordinatorType>? = nil) {
