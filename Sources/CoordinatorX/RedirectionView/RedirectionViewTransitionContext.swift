...
public class RedirectionViewTransitionContext<RouteType: Route, CoordinatorType: RedirectionCoordinator>: TransitionContext where RouteType == CoordinatorType.RouteType {
    ...
    weak public var prevTransitionContext: RedirectionViewTransitionContext<RouteType, CoordinatorType>?
    weak public var prevRouter: (any Router<RouteType>)? {
        prevTransitionContext
    }
    weak public var nextTransitionContext: RedirectionViewTransitionContext<RouteType, CoordinatorType>?
    ...
    private func contextTrigger(route: RouteType,
        ...
        case .parent(let parentRoute): parentRouter?.prevRouter?.trigger(parentRoute)
